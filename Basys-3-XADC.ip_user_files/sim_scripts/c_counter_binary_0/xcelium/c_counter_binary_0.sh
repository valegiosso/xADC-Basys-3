...
#
# Script generated by Vivado on Fri Jun 06 11:37:19 -0300 2025
...
# script info
echo -e "c_counter_binary_0.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.c_counter_binary_0
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.c_counter_binary_0 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log c_counter_binary_0_sc.so .tmp_log xcelium_lib waves.shm c.obj)
