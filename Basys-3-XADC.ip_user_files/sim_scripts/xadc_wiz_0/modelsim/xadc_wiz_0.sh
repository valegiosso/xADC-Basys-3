...
copy_setup_file()
{
  file="modelsim.ini"
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Users/enzof/OneDrive/Desktop/Basys-3-XADC-2018.2-3-20250607T134110Z-1-001/Basys-3-XADC-2018.2-3/vivado_proj/Basys-3-XADC.cache/compile_simlib/modelsim"
  fi
